...
### v2.3 (2026-02-22)
*   ✨ **可视化升级**：新增拇指跟随指示器，捏合时在双指中心显示红色书写点，视觉反馈更直观。
*   🎨 **细节优化**：拇指指示器颜色现在跟随画笔颜色。

### v2.2 (2026-02-22)
*   🔧 **环境适应性**：新增“灵敏度”调节滑块，支持手动调整识别阈值以适应不同光照。
*   🚨 **状态提示**：增加手部丢失检测，长时间未检测到手部时显示红色警示文案。

### v2.1 (2026-02-22)
*   ⚡️ **稳定性优化**：引入迟滞比较器 (Hysteresis) 和状态缓冲机制，彻底解决手部微颤导致的断触问题。
*   🚀 **性能提升**：优化连线算法，支持更快速的书写速度。

### v2.0 (2026-02-22)
*   🎉 **核心交互重构**：从“食指书写”升级为“捏合落笔” (Pinch-to-Draw)，解决了无法断笔的痛点。
